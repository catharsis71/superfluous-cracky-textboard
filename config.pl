...
# Page look
use constant TITLE => 'superfluous Cracky textboard';	# Name of this image board
...
use constant TITLEIMG => 'hodgerotate.webp';			# Title image (point to a script file if rotating)
...
use constant DEFAULT_STYLE => 'Cracky';		# Default CSS style title
...
use constant DISPLAY_ID => 'thread';# How to display user IDs (0 or '': don't display,
...
use constant SILLY_ANONYMOUS => 'day';			# Make up silly names for anonymous people (same syntax as DISPLAY_ID)
