...
<tr>
	<td>
		...
		<if SPAM_TRAP><div style="display:none"><const S_SPAMTRAP><input type="text" name="name" size="19" /><input type="text" name="link" size="19" /></div></if>
...
<if SHOWTITLEIMG==1><div id="titleimagediv" style="text-align:center"><img id="titleimage" src="<var expand_filename(TITLEIMG)>" alt="<const TITLE>" title="is this real life" /></div></if>
<h1>
...
<if SHOWTITLETXT><span id="boardtitle"><const TITLE></span></if>
</h1>
...
<loop $threads>
	<a name="<var $num>"></a><hr class="threadsep" style="display:none" />
...
<hr class="threadsep" style="display:none" />
</div>
...
<hr class="threadsep-threadpagetop" style="display:none" />
...
<hr class="threadsep-threadpagebottom" style="display:none" />
